...
namespace Udemy.Dependency
{
    public class Startup
    {
        ...
        {
            //dependency injectioný tanýtýyoruz. Constructor içinde IProductService gördüðün zaman ProductManager classýný örnekle diyoruz.
            services.AddScoped<IProductService,ProductManager>();

            //services klasörü içindekileri ekleyelim
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {   //bu fonksiyon Controller=Home, Action=Index ve id? þeklinde set eder.
